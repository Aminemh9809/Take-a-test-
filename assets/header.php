...
<body>
   <?php
    $urlProject = "http://localhost:5000/projetstage/projetphp";
  // echo  $urlProject = $_SERVER['HTTP_HOST'];
   ?>
<header>
            ...
            <a class="navbar-brand" href="../../index.php">Knowledge Hub</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../users/views/view-about.php">About</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../users/controllers/controller-test.php">Tests</a>
                        </li>
                        <li class="nav-item">
